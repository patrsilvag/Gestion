...
export default function Maquiladores() {
  const storageKey = "mant_maquiladores";
  const [data, setData] = useState<any[]>([]);
  const [editingIndex, setEditingIndex] = useState<number|null>(null);
  const [form, setForm] = useState<any>({ 'codigo': '', 'razon': '', 'contacto': '', 'correo': '', 'tolerancia': '', 'estado': '' });
  ...
  const resetForm = ()=>setForm({ 'codigo': '', 'razon': '', 'contacto': '', 'correo': '', 'tolerancia': '', 'estado': '' });
  ...
  return (
    <div className="space-y-4">
      <Card>
        <CardHeader><CardTitle>Maquiladores — Formulario</CardTitle></CardHeader>
...
<SelectItem value="inactivo">Inactivo</SelectItem>
      ...
      <Card>
        <CardHeader><CardTitle>Maquiladores — Listado</CardTitle></CardHeader>
