...
export default function FamiliasCategorias() {
  const storageKey = "mant_familiascategorias";
  const [data, setData] = useState<any[]>([]);
  const [editingIndex, setEditingIndex] = useState<number|null>(null);
  const [form, setForm] = useState<any>({ 'codigo': '', 'familia': '', 'categoria': '', 'estado': '' });
  ...
  const resetForm = ()=>setForm({ 'codigo': '', 'familia': '', 'categoria': '', 'estado': '' });
  ...
  return (
    <div className="space-y-4">
      <Card>
        <CardHeader><CardTitle>FamiliasCategorias — Formulario</CardTitle></CardHeader>
...
<SelectItem value="inactivo">Inactivo</SelectItem>
      ...
      <Card>
        <CardHeader><CardTitle>FamiliasCategorias — Listado</CardTitle></CardHeader>
